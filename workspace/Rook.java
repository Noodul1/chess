...
//The Piece can move straight in all 4 directions for any distance, but cannot move
//past other peices
...
public class Rook extends Piece {
    ...
    // pre condition: board is 2d array of squares. start is a square and been
    // initialized.
    // post condition: returns arrayList of squares that the piece could
    // theorhetically capture into on the next move
    ...
    // pre condition: b is of type board and has been properly initialized. start is
    // of type square and has been properly initialized.
    // post condition: returns arrayList of possible moves such that the piece moves
    // like a rook. moves straight in all 4 directions and cannot pass over other
    // pieces.
