...
return moves;
    ...
    // it's up to you how the piece moves, but at the very least the rules should be logical and
    //it should never move off the board!
    // returns an arraylist of squares which are legal to move to
    // please note that your piece must have some sort of logic. Just being able to move to
    //every square on the board is not  going to score any points.
    // the code below is for the knight piece
    public ArrayList<Square> getLegalMoves(Board b, Square start) {
        ArrayList<Square> moves = new ArrayList<Square>();
        if ((start.getRow() + 1 < 8 && start.getCol() + 2 < 8) &&
                ((b.getSquareArray()[start.getRow() + 1][start.getCol() + 2].getOccupyingPiece() == null) ||
                        (this.getColor() != b.getSquareArray()[start.getRow() + 1][start.getCol()
                                + 2].getOccupyingPiece().getColor()))) {
        ...
        if ((start.getRow() + 2 < 8 && start.getCol() + 1 < 8) &&
                ((b.getSquareArray()[start.getRow() + 2][start.getCol() + 1].getOccupyingPiece() == null) ||
                        (this.getColor() != b.getSquareArray()[start.getRow() + 2][start.getCol()
                                + 1].getOccupyingPiece().getColor()))) {
