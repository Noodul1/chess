...
public class Bishop extends Piece {
    ...
    // Postcondition: Returns an arry list of all squares that the selected piece
    // can
    // "see", for this it is all the diagonal spaces until the bishop reaches a
    // sight "limit"
    ...
    // Postcondition: Returns an array list of all moves that can be made by the
    // bishop
    // during its turn, in diagonal directions limited by the edge of the board, its
    // own
